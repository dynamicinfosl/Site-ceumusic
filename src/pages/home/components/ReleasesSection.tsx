                  ...
                  <div className="flex-1 p-6 flex flex-col justify-between">
                    ...
                    <div className="mt-auto">
                      <button
                        ...
                        className="inline-flex items-center gap-2 bg-transparent border border-gray-600 text-white px-6 py-2.5 rounded-full font-semibold hover:border-[#C45C2F] hover:shadow-[0_0_15px_rgba(196,92,47,0.3)] hover:text-[#C45C2F] transition-all duration-300 whitespace-nowrap text-sm font-montserrat cursor-pointer"
                      >
